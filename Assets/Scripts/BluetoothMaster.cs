...
public class BluetoothMaster : MonoBehaviour
{
    ...
    public void WriteMessage2()
    {
        ...
        //BluetoothForAndroid.WriteMessage(1.0f);
    }
    ...
    {
        textField.text += "受信:"+ val.ToString() + "\n";
        ...
        switch (val)
        {
            case 1:
                ...
                videoPlayer[0].Stop();
                videoPlayer[1].Play();
                change.color = new Color(0f, 255.0f, 255.0f);
            ...
            case 2:
                ...
                videoPlayer[1].Stop();
                videoPlayer[0].Play();
                change.color = new Color( 255.0f, 0f, 255.0f);
                //break文
                break;
            case 3:
                //処理１
                change.color = new Color(255.0f, 255.0f, 0f);
            ...
            case 4:
                //処理２
                change.color = new Color(255.0f, 255.0f, 255.0f);
                //break文
                break;
        }
    }
